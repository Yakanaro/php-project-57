      ...
      <table class="mt-4">
        ...
        <tbody>
          ...
          <tr class="border-b border-dashed text-left">
            ...
            <td>
              <a data-confirm="{{ __('layout.destroy_confirmation') }}" data-method="delete" class="text-red-600 hover:text-red-900" href="{{ route('task_statuses.destroy', $taskStatus) }}" rel="nofollow">
